...
class s3 {
	...
	// -----------------------------------------
	// your API key ID
	var $keyId = MIRROR_S3_API_ID;
	// your API Secret Key
	var $secretKey = MIRROR_S3_SECRET_KEY;
	// -----------------------------------------
	// -----------------------------------------
	...
	var $bucketname = MIRROR_S3_BUCKET;
	...
	*/
	function s3($options = NULL) {
		...
		define('DATE_STRING', 'D, d M Y H:i:s +0000');
		$this->httpDate = gmdate(DATE_STRING);
